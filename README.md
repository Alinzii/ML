...
**نحوه استفاده از کد**  
1. مجموعه دیتاست در `config.yaml` را دانلود کرده و مسیرهای فایل را با تنظیمات خود تطبیق دهید.
2. دستورالعمل‌های موجود در `main.py` را برای آموزش مدل و آماده‌سازی تشخیص پرتاب دنبال کنید.
3. `shot_detector.py` را از طریق وب‌کم برای تشخیص زنده پرتاب اجرا کنید. یا یک ویدیو برای تحلیل تشخیص پرتاب وارد نمایید.
4. اگر نمی‌خواهید خودتان مدل را آموزش دهید، لطفاً از مدل از پیش آموزش‌دیده `best.pt` استفاده کنید.
